...
async function getResults() {
  ...
  const result = await contractInstance.methods.getHistory().call();
  console.log(result);
  //	console.log("Got Results"); //remember, the format is index: SellerAddress, ReceiverAddress, quantity, value
}
